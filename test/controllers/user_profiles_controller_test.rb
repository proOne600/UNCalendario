...
class UserProfilesControllerTest < ActionDispatch::IntegrationTest
  ...
  #     post user_profiles_url, params: { user_profile: { birth: @user_profile.birth, last_name: @user_profile.last_name, name: @user_profile.name, user_id: @user_profile.user_id } }
  #   end
  #
  ...
  #   patch user_profile_url(@user_profile), params: { user_profile: { birth: @user_profile.birth, last_name: @user_profile.last_name, name: @user_profile.name, user_id: @user_profile.user_id } }
