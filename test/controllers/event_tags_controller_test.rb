...
class EventTagsControllerTest < ActionDispatch::IntegrationTest
  ...
  #     post event_tags_url, params: { event_tag: { description: @event_tag.description, event_id: @event_tag.event_id, id_category: @event_tag.id_category, name: @event_tag.name } }
  #   end
  #
  ...
  #   patch event_tag_url(@event_tag), params: { event_tag: { description: @event_tag.description, event_id: @event_tag.event_id, id_category: @event_tag.id_category, name: @event_tag.name } }
