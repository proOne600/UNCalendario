class EventTagsController < ApplicationController
  ...
  private
    ...
    def event_tag_params
      #params.require(:event_tag).permit(:event_id, :id_category, :name, :description)
      params.require(:event_tag).permit((:event).permit(id), (:category).permit(id), :name, :description)
    end
end
